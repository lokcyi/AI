...
dataset_train = pd.read_csv('./Stock-prediction-RNN--master/Google_Stock_Price_Train.csv')
...
dataset_test = pd.read_csv('./Stock-prediction-RNN--master/Google_Stock_Price_Test.csv')
