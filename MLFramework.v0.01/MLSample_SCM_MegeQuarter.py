...
class MLSample(MLBase):
    def __init__(self):
        ...
        self.config.modelFileKey="Parts_Tools_30Quater" 
    ...
    def dataPreHandler(self):
        ...
        pd.merge(df_parts, df_EQP, left_on=['EQP_NO','MFG_MONTH'], right_on=['TOOL_ID','MFG_MONTH'],how="inner").to_csv(self.config.datafilee, index=False)
